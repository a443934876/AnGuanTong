 ...
 */
public class SbjcListInfoDao extends AbstractDao<DeviceInfo, Long> {
    ...
    public static class Properties {
        ...
        public final static Property SeviceLocation = new Property(7, String.class, "seviceLocation", false, "SEVICELOCATION");
    }
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'SBJC_LIST_INFO' (" + //
                ...
                "'DEVICELOCATION' TEXT);"); // 7: deviceLocation
    }
    ...
    protected void bindValues(SQLiteStatement stmt, DeviceInfo entity) {
        ...
        String deviceLocation = entity.getDeviceLocation();
        if (deviceLocation != null) {
            stmt.bindString(8, deviceLocation);
        }
    }
    ...
    public DeviceInfo readEntity(Cursor cursor, int offset) {
        DeviceInfo entity = new DeviceInfo( //
                ...
                cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7) // deviceLocation
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, DeviceInfo entity, int offset) {
        ...
        entity.setDeviceLocation(cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7));
    }

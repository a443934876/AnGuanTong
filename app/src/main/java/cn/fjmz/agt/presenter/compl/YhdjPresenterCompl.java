...
import cn.fjmz.agt.presenter.IYhdjPresenter;
...
public class YhdjPresenterCompl implements IYhdjPresenter {
    ...
    @Override
    public void getSbData(String CsId) {

    }

    @Override
    public void getJcbDetail(String jcbId) {
    ...
    @Override
    public void upload(AqjcCommitInfo info) {
    ...
    @Override
    public void getSssb(int pSbid, int comid) {

...
#-keepclassmembers class cn.ffcs.partyschool.activity.WebViewActivity {
#   public *;
#}
...
##-----------处理js交互---------------
#
#-keep class cn.ffcs.partyschool.activity.WebViewActivity.** {*;}
#
##-----------处理实体类---------------
## 在开发的时候我们可以将所有的实体类放在一个包内，这样我们写一次混淆就行了。
#-keep public class cn.ffcs.partyschool.model.**
#
#-keep public class cn.ffcs.partyschool.widget.**
#
#-dontwarn cn.ffcs.partyschool.utils.**
#-keep public class cn.ffcs.partyschool.utils.**
#
...
#
#-dontwarn com.example.jcenterlibrary.**
...
#
## Gson
#-keep class cn.ffcs.partyschool.model.**{*;} # 自定义数据模型的bean目录
#
## Retrolambda
